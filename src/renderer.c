...
int renderer_init(Renderer* r, GLFWwindow* window, GraphData* graph) {
    ...
    VkVertexInputAttributeDescription na[] = { {0,0,VK_FORMAT_R32G32B32_SFLOAT,0}, {1,0,VK_FORMAT_R32G32B32_SFLOAT,12}, {2,0,VK_FORMAT_R32_SFLOAT,24}, {3,1,VK_FORMAT_R32G32B32_SFLOAT,offsetof(Node, position)}, {4,1,VK_FORMAT_R32G32B32_SFLOAT,offsetof(Node, color)}, {5,1,VK_FORMAT_R32_SFLOAT,offsetof(Node, size)}, {6,1,VK_FORMAT_R32_SFLOAT,offsetof(Node, glow)} };
    VkPipelineVertexInputStateCreateInfo nvi = { .sType = VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_STATE_CREATE_INFO, .vertexBindingDescriptionCount = 2, .pVertexBindingDescriptions = nb, .vertexAttributeDescriptionCount = 7, .pVertexAttributeDescriptions = na };
