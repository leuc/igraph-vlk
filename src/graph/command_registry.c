...
const CommandDef g_command_registry[] = {
	...
	{"Follow/Main Path/Weighting", "main_path_splc", "SPLC", compute_main_path_splc, apply_main_path_weighting, free_main_path_prep, poll_main_path_weighting},
	{"Follow/Main Path/Weighting", "main_path_unit", "Unit", compute_main_path_unit, apply_main_path_weighting, free_main_path_prep, poll_main_path_weighting},
	{"Follow/Main Path/Weighting", "main_path_spc", "SPC", compute_main_path_spc, apply_main_path_weighting, free_main_path_prep, poll_main_path_weighting},
	{"Follow/Main Path/Weighting", "main_path_spe", "SPE", compute_main_path_spe, apply_main_path_weighting, free_main_path_prep, poll_main_path_weighting},
