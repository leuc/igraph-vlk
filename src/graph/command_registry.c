...
const CommandDef g_command_registry[] = {
	...
	{"Follow/Main Path Analysis/Step 2: Selection/Search Path Link Count (SPLC)", "main_path_splc_path", "Optimal Path", compute_main_path_splc_path, apply_main_path_selection, free_main_path_selection},
	...
	{"Follow/Main Path Analysis/Step 2: Selection/Search Path Count (SPC)", "main_path_spc_path", "Optimal Path", compute_main_path_spc_path, apply_main_path_selection, free_main_path_selection},
	...
	{"Follow/Main Path Analysis/Step 2: Selection/Search Path Entropy (SPE)", "main_path_spe_path", "Optimal Path", compute_main_path_spe_path, apply_main_path_selection, free_main_path_selection},
	...
	{"Follow/Main Path Analysis/Step 2: Selection/Unit Weight", "main_path_unit_path", "Optimal Path", compute_main_path_unit_path, apply_main_path_selection, free_main_path_selection},
	...
	{"Follow/Main Path Analysis/Step 2: Selection/Node Pair Projection Count (NPPC)", "main_path_nppc_path", "Optimal Path", compute_main_path_nppc_path, apply_main_path_selection, free_main_path_selection},
	...
	{"Follow/Main Path Analysis/Step 2: Selection/Search Path Count (SPC)", "main_path_spc_network", "Network", compute_main_path_spc_network, apply_main_path_selection, free_main_path_selection},
	...
	{"Follow/Main Path Analysis/Step 2: Selection/Search Path Entropy (SPE)", "main_path_spe_network", "Network", compute_main_path_spe_network, apply_main_path_selection, free_main_path_selection},
	...
	{"Follow/Main Path Analysis/Step 2: Selection/Unit Weight", "main_path_unit_network", "Network", compute_main_path_unit_network, apply_main_path_selection, free_main_path_selection},
	...
	{"Follow/Main Path Analysis/Step 2: Selection/Node Pair Projection Count (NPPC)", "main_path_nppc_network", "Network", compute_main_path_nppc_network, apply_main_path_selection, free_main_path_selection},
