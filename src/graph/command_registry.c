...
const CommandDef g_command_registry[] = {
	...
	{"Follow/Main Path/Weighting", "main_path_splc", "SPLC", compute_splc_animation, apply_splc_animation, free_main_path_prep, poll_splc_gpu},
	{"Follow/Main Path/Weighting", "main_path_unit", "Unit", compute_main_path_unit, apply_main_path_weighting, free_main_path_weighting_result, poll_main_path_weighting},
	{"Follow/Main Path/Weighting", "main_path_spc", "SPC", compute_main_path_spc, apply_main_path_weighting, free_main_path_weighting_result, poll_main_path_weighting},
	{"Follow/Main Path/Weighting", "main_path_spe", "SPE", compute_main_path_spe, apply_main_path_weighting, free_main_path_weighting_result, poll_main_path_weighting},
	{"Follow/Main Path/Selection/SPLC", "main_path_splc_basket", "Basket", compute_main_path_splc_basket, apply_main_path_basket, free_main_path_prep, poll_main_path_basket},
	...
	{"Follow/Main Path/Selection/SPC", "main_path_spc_basket", "Basket", compute_main_path_spc_basket, apply_main_path_basket, free_main_path_prep, poll_main_path_basket},
	...
	{"Follow/Main Path/Selection/SPE", "main_path_spe_basket", "Basket", compute_main_path_spe_basket, apply_main_path_basket, free_main_path_prep, poll_main_path_basket},
	...
	{"Follow/Main Path/Selection/Unit", "main_path_unit_basket", "Basket", compute_main_path_unit_basket, apply_main_path_basket, free_main_path_prep, poll_main_path_basket},
	{"Follow/Main Path/Selection/Unit", "main_path_unit_path", "Optimal Path", compute_main_path_unit_path, apply_main_path_selection, free_main_path_selection},
