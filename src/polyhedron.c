...
static void
add_tri (Vertex *vs, uint32_t *is, int *v, vec3 p1, vec3 p2, vec3 p3)
{
...
void
polyhedron_generate_platonic (PlatonicType type, Vertex **vertices,
    ...
    case PLATONIC_ICOSAHEDRON:
      {
        ...
        *indices = malloc (60 * 4);
        int v = 0;
        vec3 p[12] = { { 0, 1, phi },   { 0, 1, -phi },  { 0, -1, phi },
    ...
    case PLATONIC_DODECAHEDRON:
      {
        ...
        *indices = malloc (108 * 4);
        ...
        int f[12][5] = { { 0, 16, 2, 10, 8 },  { 0, 8, 4, 14, 12 },
                         { 16, 17, 1, 12, 0 }, { 1, 9, 11, 3, 17 },
                         { 1, 12, 14, 5, 9 },  { 2, 13, 15, 6, 10 },
                         { 13, 3, 11, 7, 15 }, { 3, 17, 16, 2, 13 },
