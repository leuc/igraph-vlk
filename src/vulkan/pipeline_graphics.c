...
void renderer_create_graphics_pipelines(Renderer *r)
{
	...
	VkVertexInputAttributeDescription edgeAttributes[] = {{0, 0, VK_FORMAT_R32G32B32_SFLOAT, 0}, {1, 1, VK_FORMAT_R32G32B32_SFLOAT, 0}, {2, 1, VK_FORMAT_R32_SFLOAT, 12}, {3, 1, VK_FORMAT_R32_SFLOAT, 16}, {4, 1, VK_FORMAT_R32_SFLOAT, 20}, {5, 2, VK_FORMAT_R32G32B32_SFLOAT, 0}, {6, 1, VK_FORMAT_R32_SFLOAT, 24}};
	VkPipelineVertexInputStateCreateInfo edgeVertexInput = {.sType = VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_STATE_CREATE_INFO, .vertexBindingDescriptionCount = 3, .pVertexBindingDescriptions = edgeBindings, .vertexAttributeDescriptionCount = 7, .pVertexAttributeDescriptions = edgeAttributes};
