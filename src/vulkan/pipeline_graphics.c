...
void renderer_create_graphics_pipelines(Renderer *r)
{
	...
	VkVertexInputAttributeDescription nodeAttributes[] = {{0, 0, VK_FORMAT_R32G32B32_SFLOAT, 0}, {1, 1, VK_FORMAT_R32G32B32_SFLOAT, 0}, {2, 2, VK_FORMAT_R32G32B32_SFLOAT, 0}, {3, 2, VK_FORMAT_R32_SFLOAT, 12}, {4, 2, VK_FORMAT_R32_SINT, 16}, {5, 2, VK_FORMAT_R32_SFLOAT, 20}, {6, 2, VK_FORMAT_R32_SFLOAT, 24}};
	VkPipelineVertexInputStateCreateInfo nodeVertexInput = {.sType = VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_STATE_CREATE_INFO, .vertexBindingDescriptionCount = 3, .pVertexBindingDescriptions = nodeBindings, .vertexAttributeDescriptionCount = 7, .pVertexAttributeDescriptions = nodeAttributes};
