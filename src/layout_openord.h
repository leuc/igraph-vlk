...
typedef struct OpenOrdContext {
    int stage_id; // 0:Liquid, 1:Expansion, 2:Cooldown, 3:Crunch, 4:Simmer, 5:Done
    int current_iter;
    int total_iters;
...
bool openord_step(OpenOrdContext* ctx, GraphData* graph); // Returns true if running, false if done
